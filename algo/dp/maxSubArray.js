...
function test() {
    const testCases = [
        { nums: [-2, 1, -3, 4, -1, 2, 1, -5, 4], expected: 6, expectedSubArray: [4, -1, 2, 1] },
        { nums: [1], expected: 1, expectedSubArray: [1] },
        { nums: [5, 4, -1, 7, 8], expected: 23, expectedSubArray: [5, 4, -1, 7, 8] },
        { nums: [-1], expected: -1, expectedSubArray: [-1] },
    ...
    for (const { nums, expected } of testCases) {
        ...
        console.log(`DP解法结果: ${maxSum1}, 期望: ${expected}, 正确: ${maxSum1 === expected}`);
        console.log(`Kadane算法结果: ${maxSum2}, 期望: ${expected}, 正确: ${maxSum2 === expected}`);
        console.log(`分治法结果: ${maxSum3}, 期望: ${expected}, 正确: ${maxSum3 === expected}`);
